...
function App() {
  ...
  {/* Right side: Button */}
  <button className="bg-blue-600 text-black overflow-ellipsis rounded-b-full hover:bg-blue-700 border-none transition flex items-center space-x-1 ml-2">
    <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" className="size-8">
